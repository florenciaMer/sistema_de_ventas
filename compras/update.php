...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Actualizar una Compra</h1>
                             ...
                             <div class="col-md-9 d-flex">
                                 ...
                                 <div class="col-md-3">
                                     <div class="class form-group">
                                         ...
                                         <input type="text" name="id_producto" id="id_producto" hidden value="<?php echo $id_producto?>" class="form-control" >
                             ...
                             <div class="col-md-9 d-flex">
                                 ...
                                 <div class="col-md-4">
                                     <div class="class form-group">
                                         ...
                                         <input type="text" name="fecha_ingreso" id="fecha_ingreso" disabled class="form-control"  value="<?php echo $fecha_ingreso?>">>
                                     </div>
                                 </div>
                             </div>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input hidden id="id_proveedor" value="<?php echo $id_proveedor?>" type="text" class="form-control">
    ...
    <div class="row col-md-3">
        <div class="card card-outline card-primary">
            ...
            <div class="card-body">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="numero_compra" name=""  value="<?php  echo $nro_compra;?>">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="fecha_compra" name="fecha" value="<?php echo $fecha_compra;?>">
                    </div>
                </div>
                <div class="col-md-12">
                    <div class="class form-group">
                        ...
                        <div class="d-flex">
                            ...
                            <?php 
                                ...
                                foreach($comprobantes_datos as $comprobante_dato){ 
                                $id_comprobante = $comprobante_dato['id_comprobante'];
                                $nombre_comprobante_tabla = $comprobante_dato['nombre_comprobante'];?>
                                <option value="<?php echo $id_comprobante; ?>"
                                    <?php if ($nombre_comprobante_tabla == $nombre_comprobante) {?> selected="selected"<?php } ?>>
                                    <?php echo $nombre_comprobante_tabla;?>
                                </option>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" disabled id="stock_actual" class="form-control"name="stock_actual" value="<?php echo $stock_actual;?>">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" id="stock_total" class="form-control"name="stock_total">
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="number" id="cantidad_compra" class="form-control"name="cantidad"value="<?php echo $cantidad?>">
                        </div>
                        <script>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input type="string" class="form-control" id="total_compra" name="total_compra" value="<?php echo $total_compra?>" disabled>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <button class="btn btn-success block" id="btn_actualizar_compra">Actualizar</button>
                </div>
            </div>
