...
<div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-12">
                    <h1 class="m-0">Eliminacion de la Compra</h1>
                </div><!-- /.col -->
                     ...
                     <div class="class col-md-12">
                         <div class="card card-danger">
                             <div class="card-header">
                                 <h3 class="card-title">¿Esta seguro de eliminar la compra Nro <?php echo $nro_compra ?>?</h3>
                             ...
                             <div class="col-md-9 d-flex">
                                 <div class="col-md-3">
                                     <div class="class form-group">
                                         ...
                                         <input type="text" id="id_producto" hidden value="<?php echo $id_producto ?>" class="form-control" name="id_producto">
